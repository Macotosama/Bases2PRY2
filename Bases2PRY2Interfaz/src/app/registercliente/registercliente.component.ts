...
@Component({
  ...
  styleUrls: ['./registercliente.component.scss']
})
export class RegisterclienteComponent implements OnInit {
  ...
  constructor(private servicios: Service, private _snackBar: MatSnackBar, public dialogRef: MatDialogRef<RegisterclienteComponent>) { }
